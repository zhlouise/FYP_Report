...
without accounting for variations over time. \hl{In contrast, trajectory planning
defines the path as a function of time, assigning specific timing to the
geometric route} \cite{gasparetto2015path}. \hl{Currently, our research focuses on
...
future investigation. (Really need to say trajectory planning?)}
