...
obstacles \cite{karaman2011samplingbasedalgorithmsoptimalmot}.  To avoid such burnout, sampling-based algorithms have been proposed
...
forth \cite{choset2000coverage}. Compared to spiral patterns, which cause the UAV to constantly turn,
leading to unstable antenna orientation, using boustrophedon keeps the drone stable
...
algorithm is discussed in the methodology section. The section below reviews
existing GNSS-R techniques that can be used once the path planning methodologies have been
established.
