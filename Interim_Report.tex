...
designed to first navigate around an obstacle and then determine the
...
have trained deep learning models on GNSS-R features. One study trained a ANN on
...
frame of the sensors. In practise, the common approaches to frame-to-frame odometry are visual
odometry or LiDAR odometry. Visual odometry estimates motion by tracking
distinct features in each image frame through gradients and textures while LiDAR
odometry uses laser range measurements to scan the environment. Since our
project focuses on investigating forests and dense vegetation, LiDAR odometry is
preferred as it is not affected by visually repetitive scenes and varying
lighting conditions that cause instability in camera-based methods. 
...
The system architecture adapted in this project is as shown below.
\begin{figure}[H]
    \centering
...
and in the ground controller. For this experiment, we use QGround Control
\cite{QGroundControl_PlanView} as the ground controlling software and use 433MHz
...
On the other hand, \hl{(ROS set up)}
...
\begin{longtable}{|m{0.03\textwidth}|m{0.05\textwidth}|m{0.12\textwidth}|m{0.25\textwidth}|m{0.4\textwidth}|}
    ...
    \hline
    \endfoot
    (a) & 2025 Oct. 01 & Homantin Mountain & & \includegraphics[width=\linewidth]{Included_Images/HomantinMountainTrack.png}\\ 
    \hline
    (b) & 2025 Oct. 12 & Tai Hang Tun & & \includegraphics[width=\linewidth]{Included_Images/TaiHangTunTree.png}\\ 
    \hline
    (c) & 2025 Oct. 12 & Tai Hang Tun & & \includegraphics[width=\linewidth]{Included_Images/TaiHangTunGrass.png}\\ 
    \hline
    (d) & 2025 Oct. 12 & Tai Hang Tun & & \includegraphics[width=\linewidth]{Included_Images/TaiHangTunDynamic.png}\\ 
    \hline
    (e) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai113425.png}\\ 
    \hline
    (f) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai115109.png}\\ 
    \hline
    (g) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai113830.png}\\ 
    \hline
    (h) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai103755.png}\\ 
    \hline
    (i) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai101211.png}\\ 
    \hline
    (j) & 2025 Nov. 09 & Nam Sang Wai & & \includegraphics[width=\linewidth]{Included_Images/NamSangWai094324.png}\\ 
    \hline
\end{longtable}
...
\ganttbar[bar/.style={fill=overallcolor}]{UAV Setup}{2025-10-01}{2025-12-31} \\
\ganttbar[bar/.style={fill=overallcolor}]{Phase 1 Experiments}{2025-11-01}{2026-01-31} \\
\ganttbar[bar/.style={fill=overallcolor}]{Interim Report \& Presentation}{2026-02-01}{2026-03-31} \\
\ganttbar[bar/.style={fill=overallcolor}]{Phase 2 Experiments}{2026-03-01}{2026-04-30} \\
