...
while the regression task will help to predict vegetation parameters and assess 
the performance of the GNSS-R framework. Ultimately, this will enhance the
robustness and accuracy of the GNSS-R vegetation monitoring system.
