...
figures below, PGO+GPS have misaligned point clouds due to the GPS coordinate
frame and transformation logic issues. In PGO+GPS, the green trajectory
indicates the LiDAR odometry, and 3 axis trajectory indicates GPS trajectory. 
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.49\textwidth}
