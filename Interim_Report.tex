...
\cite{gasparetto2015path}. Currently, our research focuses on implementing path
...
\cite{Kavraki},\cite{kavraki_etal}. The most common sampling-based algorithms are
...
As can be seen from the table above, a multiclass objective function was used
...
\begin{longtable}{|m{0.03\textwidth}|m{0.05\textwidth}|m{0.11\textwidth}|m{0.25\textwidth}|m{0.4\textwidth}|}
    ...
    manual flight control where it hovers above bare ground with grass for 3
    minutes. &
    ...
    successful implementation of path planning where the UAV hovers above bare
    ground with grass in two different points for 2 minutes respectively. &
    ...
    planning where the UAV is hovering over bare ground with grass for 2 minutes
    and above trees for 3 minutes &
    ...
    manual flight control. However, we face the problem of controlling the UAV
    mid-way due to large wind velocity. Hence resulting in irregular flight
    path. &
    ...
    planning where the UAV is hovering over bare ground with grass in two
    different points for 3 minutes respectively. &
    ...
    planning where the UAV is hovering over bare ground with grass for 3 minutes
    and above trees for 5 minutes. &
    ...
    UAV hovers above each waypoint for one minute, with a total of six waypoints
    ...
    implementation of using surveying function from QGroundControl to carry out
...
developing neural netwok based model to perform regression tasks to predic
