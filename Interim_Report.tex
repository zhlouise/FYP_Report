...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{Included_Images/rrt_vs_rrtstar.png}
...
Figure \ref{fig:forest_path} shows two different start and end points, and how the A* algorithm
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Included_Images/cpp_gui.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Included_Images/env_obstacles.png}
