...
Delay Doppler Maps (DMMs), SNR, signal incidence angle and geographic data to
...
binary classification model at various threshold settings. It plot the True Positive Rate (TPR) against the False Positive
