...
extracts raw GNSS measurements, and analyzes the characteristics of such measurements
with respect to the ground features that falls within the Fresnel zones. Ultimately,
the correlation between GNSS measurement features and vegetation properties would be 
systematically summarized and modeled. The theories of retrieving GNSS measurements and
the Fresnel zone is briefly outlined in the following two sections.
...
Following the extraction of GNSS measurements observed onboard the UAV, the reflected
