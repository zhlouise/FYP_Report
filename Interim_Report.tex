...
power of the direct and reflected signals was coherently added, in which the
resulting power oscillations due to interference present notches that are
correlated to vegetation layer thickness and the reflection geometry (Figure
\ref{SMIGOL}) \cite{RodriguezAlvarez2011}. As a result, an RMSE of 3-5 cm in
estimating the height of vegetation with simple geometrical structures (barley
and wheat) could be achieved \cite{RodriguezAlvarez2011}.
...
This section presents the results obtained from the four different
implementations of this project. It includes path planning, GNSS-R signal
