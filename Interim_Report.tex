...
\cite{QGroundControl_PlanView} was used as the ground controlling software and used 433 MHz
...
altitude will be roughly around 30 m. Figure \ref{fig:qgc_mission_list} shows an
...
executed. Lastly, the collected data could be downloaded and post-processed for
further analysis.

\subsection{Summary of Experiments Conducted}
A total of 10 successful flights were conducted during the reporting period. They were carried out in three locations: Homantin Mountain, Tai Hang Tun Kite Flying Area, and Nam Sang Wai. Photos showing the experiment locations are arranged in Figure \ref{Experiment Environment} and the experiments are summarized in Table \ref{Experiment Summary}.
...
analysed to evaluate the effectiveness of each subsystem, and discuss how
...
To address this limitation, we will use uavpackage
