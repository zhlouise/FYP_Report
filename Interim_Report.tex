...
parameters retrieved through GNSS-R and ground vegetation conditions. This
involves collecting and post-processing raw GNSS data, extracting GNSS signal
measurements, and analyzing GNSS signal parameters with respect to ground
regions reflecting the signal. Ultimately, such correlations would be modelled
both quantitatively and qualitatively such that the ground vegetation conditions
could be effectively predicted from the GNSS signal properties received onboard
the UAV.
...
be systematically modelled. Additionally, machine learning methods will
...
On the other hand, SLAM data including LiDAR, IMU, and GPS data are
...
\subsection{GNSS-R}
In the next part of this project, the GNSS-R framework will integrate with the 
