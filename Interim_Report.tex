...
This involves creating a modular SLAM system, with the front-end being LiDAR
Odometry and the back-end being GPS-coupled pose graph optimization SLAM to
create an accurate map of the vegetation. 
\end{enumerate}
