...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{Included_Images/Spectral_camera_image.png}
        \caption{Spectral Imagery}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{Included_Images/LiDARIntro.jpg}
        \caption{LiDAR Point Clouds}
    \end{subfigure}
    \caption{Two types of common remote sensing instruments found on UAV platforms.}
\end{figure}
