...
The GNSS-R framework or approach can characterise the reflected signals 
...
Recent studies have shown that machine learning models are well suited to explore the multi dimensional nature of GNSS-R measurements.
A recent study on neural network based approach for spaceborne GNSS-R data has demonstrated to achieve high prediction reslts for Vegetation Water Content (VWC) 
...
dual antenna setup constitutes a rich knowledge set that is suitable for training a machine learning model for classifying signal types and surface characteristics. The 
