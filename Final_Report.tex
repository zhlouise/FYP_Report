...
\subsection{Methodology}
In this project, a RL polarization system is adopted onboard the UAV: the zenith
antenna receives the RHCP signals transmitted directly from the satellite, while
the nadir antenna receives the LHCP signals after they have reflected off
various ground features. A schematic representation of the RL polarization
system, as well as the two types of GNSS signal polarization types, are shown in
Figure \ref{RL System} below. 

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.7\textwidth}
        \includegraphics[width=\textwidth]{Included_Images/RL_system.png}
    ...
    \end{subfigure}
    \caption{RL polarization system adopted for this project and GNSS signal polarization types.}
    \label{RL System}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Normalized distributions of pseudorange errors for both antennas in 
...
Distribution} has already challenged this assumption. To investigate further,
the distribution of the difference between the absolute pseudorange errors of
the nadir and zenith antennas is plotted in Figure \ref{Pr_Error Difference}.
\begin{figure}[H]
    \centering
...
indicating that the zenith antenna can receive reflected signals. Since the zenith
...
gains. This phenomenon is further demonstrated in a subsequent experiment, where both
