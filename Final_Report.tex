...
% --- Conclusion ---
\section{Conclusion}
In conclusion, our results demonstrate the successful establishment
of a comprehensive UAV-based framework that integrates autonomous path planning,
...
environments. Moreover, the interactive path planner system determines the
optimal detection area by clustering the Fresnel zones, yielding a suitable
sweeping distance for coverage path planning. As a result, optimized survey
...
on the literature review, methodology development, finalizing connections between
...
The path planning component of the project is led by GAMAGE Sashenka, who has
been focusing on developing and testing path planning algorithms in the local
mapping environment and in QGround Control. As a result, simulations were
conducted to verify the locally developed A* algorithm in a dynamic UAV
environment. Moreover, an interactive path planning system was developed to
identify areas with reflected GNSS signals and obtain stronger data points.

The LiDAR SLAM part of the project is led by TAN Qing Lin. She has been
...
The GNSS-R part of the project is led by ZHOU Jiayi, who has been focusing on
...
The ML part of the project is led by MAHMUD Md Sahat, who has been working on
