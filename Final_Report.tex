...
\subsubsection{Image Processing and Vegetation Classification} ~\\
...
specified geographic location and time instance. By providing the desired
latitude, longitude, and timestamp as inputs, the MATLAB simulation framework
developed in this study computes and visualizes the corresponding Fresnel zones.
...
\ref{fig:fresnel_zone_identification} shows the Fresnel zones plotted in Mount
...
Based on this distribution, a clustering threshold is defined to
identify neighboring Fresnel zones that are closely aligned. In this study, the
threshold is selected to include approximately the closest 40\% of Fresnel
zones, allowing closer adjacent zones to be grouped into clusters. If multiple
clusters are identified, the final cluster selection is determined by the
distance of each cluster to the computed global center. The selected cluster is
then designated as the primary region of interest for detection. 
...
To optimize the area of interest, a parameter termed the
\textit{coverage ratio} is introduced. The coverage ratio is defined as the ratio
...
In addition, the unused or empty area within the enclosure can be calculated as:
...
that the final detection area maximizes coverage efficiency while minimizing
unnecessary survey space.             
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Included_Images/cpp_gui.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Included_Images/F1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Included_Images/Confusion-matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Included_Images/ROC.png}
...
A total of 24 successful mission flights were conducted for this project.
They were carried out in five locations: Homantin Mountain, Tai Hang Tun Kite
Flying Area, Nam Sang Wai, Mount Davis Service Reservoir Garden, and Upper Shing Mun Reservoir Barbecue Area. Photos showing the experiment locations are
arranged in Figure \ref{Experiment Environment} and the experiments are
summarized in Table \ref{Experiment-Summary}.
...
\begin{longtable}{|m{0.03\textwidth}|m{0.05\textwidth}|m{0.1\textwidth}|m{0.25\textwidth}|m{0.4\textwidth}|}
    \caption{Summary of Experiments Conducted}
    \label{Experiment-Summary}\\
    \hline
    & \textbf{Date} & \textbf{Location} & \textbf{Descriptions} & \textbf{Flight
    Trajectory}\\ 
    \hline
    \endfirsthead
    \hline
    ...
    \hline
    \endfoot
    (a) & 2025 Oct. 01 & Homantin Mountain & This experiment is carried out via
    manual flight control where it flies above bare ground with grass for 1.5
    minutes. &
    \includegraphics[width=\linewidth]{Included_Images/HomantinMountainTrack.png}\\ 
    \hline
    (b) & 2025 Oct. 12 & Tai Hang Tun & This experiment indicates the first
    successful implementation of path planning where the UAV takes off, then
    hovers over a specified waypoint above bare ground with grass for 8 minutes. &
    \includegraphics[width=\linewidth]{Included_Images/TaiHangTunGrass.png}\\ 
    \hline
    (c) & 2025 Oct. 12 & Tai Hang Tun & This experiment is carried out via path
    planning where the UAV takes off, then hovers over a specified waypoint
    above trees for 7 minutes. &
    \includegraphics[width=\linewidth]{Included_Images/TaiHangTunTree.png}\\ 
    \hline
    (d) & 2025 Oct. 12 & Tai Hang Tun & This experiment is carried out via
    manual flight control. However, due to large wind velocity, the UAV drifts
    significantly and manual control became difficult, hence resulting in
    irregular flight path. &
    \includegraphics[width=\linewidth]{Included_Images/TaiHangTunDynamic.png}\\ 
    \hline
    (e) & 2025 Nov. 09 & Nam Sang Wai & This experiment is carried out via path
    planning, where the UAV takes off and hovers over bare ground with grass for
    a total of 11 minutes. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai094324.png}\\ 
    \hline
    (f) & 2025 Nov. 09 & Nam Sang Wai & This experiment is carried out via path
    planning, where the UAV takes off and hovers over trees for a total of 11
    minutes. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai101211.png}\\ 
    \hline
    (g) & 2025 Nov. 09 & Nam Sang Wai & This experiment is conducted by manually
    assigning multiple waypoints in QGroundControl to perform path planning. The
    UAV hovers above each waypoint for half a minute, with a total of 12 waypoints
    assigned in the mission. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai103755.png}\\    
    \hline
    (h) & 2025 Nov. 09 & Nam Sang Wai & This experiment indicates the first
    implementation of using the surveying function from QGroundControl to carry out
    coverage path planning. The UAV is going back and forth between bare ground
    with grass and tree clusters. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai113425.png}\\ 
    \hline
    (i) & 2025 Nov. 09 & Nam Sang Wai & This experiment demonstrates wider-area
    coverage through autonomous path planning, similar to (h) where it allows
    the UAV to systematically fly over clusters of trees. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai113830.png}\\ 
    \hline
    (j) & 2025 Nov. 09 & Nam Sang Wai & This experiment was also carried out via
    autonomous coverage path planning, but in the opposite direction compared to
    experiment (h) and (i) when scanning tree clusters. &
    \includegraphics[width=\linewidth]{Included_Images/NamSangWai115109.png}\\ 
    \hline
    (k) & 2026 Feb. 01 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis1_1.png}\\
    \hline
    (l) & 2026 Feb. 01 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis1_2.png}\\
    \hline
    (m) & 2026 Feb. 01 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis1_3.png}\\
    \hline
    (n) & 2026 Feb. 01 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis1_4.png}\\
    \hline
    (o) & 2026 Feb. 01 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis1_5.png}\\
    \hline
    (p) & 2026 Mar. 08 & Shing Mun & BS & \includegraphics[width=\linewidth]{Included_Images/Shingmun1.png}\\
    \hline
    (q) & 2026 Mar. 08 & Shing Mun & BS & \includegraphics[width=\linewidth]{Included_Images/Shingmun2.png}\\
    \hline
    (r) & 2026 Mar. 08 & Shing Mun & BS & \includegraphics[width=\linewidth]{Included_Images/Shingmun3.png}\\
    \hline
    (s) & 2026 Mar. 08 & Shing Mun & BS & \includegraphics[width=\linewidth]{Included_Images/Shingmun4.png}\\
    \hline
    (t) & 2026 Mar. 08 & Shing Mun & BS & \includegraphics[width=\linewidth]{Included_Images/Shingmun5.png}\\
    \hline
    (u) & 2026 Mar. 31 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis2_1.png}\\
    \hline
    (v) & 2026 Mar. 31 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis2_2.png}\\
    \hline
    (w) & 2026 Mar. 31 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis2_3.png}\\
    \hline
    (x) & 2026 Mar. 31 & Mount Davis & BS & \includegraphics[width=\linewidth]{Included_Images/MtDavis2_4.png}\\
    \hline
\end{longtable} 


% --- Case Study ---
\section{Case Study: Experiment (i)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Included_Images/KeyExperiment_ML.png}
